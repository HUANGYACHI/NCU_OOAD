        ...
        implements IFuncComponent, ILinePainter
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g2.setStroke(new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 1.0f, dash1, 2f));
        g.drawLine(fpPrime.x, fpPrime.y, tpPrime.x, tpPrime.y);
    ...
    // modify 2
    public JPanel getFromObj() { return this.from; }
    public JPanel getToObj() { return this.to; }
